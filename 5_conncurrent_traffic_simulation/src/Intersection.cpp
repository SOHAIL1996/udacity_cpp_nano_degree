...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if (_trafficLights.getCurrentPhase() == TrafficLightPhase::red){
        std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << " is at a red traffic light." << std::endl; 
        _trafficLights.waitForGreen();
    };
    std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << " is at a green traffic light." << std::endl; 
...
bool Intersection::trafficLightIsGreen()
{
   ...
   if (_trafficLights.getCurrentPhase() == TrafficLightPhase::green)
       return true;
   else
       return false;
